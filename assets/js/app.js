...
// Appels AJAX
function login() {
  fetch('./actions/utilisateurs/login.php', {
    method: 'POST',
    body: JSON.stringify({
  ...
  .then(data => {
    if (data.status === 'success') {
      ...
      } else if (['acheteur', 'agriculteur', 'fournisseur', 'conseiller', 'vendeur'].includes(data.role)) {
...
function register() {
    fetch('./actions/utilisateurs/register.php', {
      method: 'POST',
      body: JSON.stringify({
...
function resetPassword() {
  fetch('./actions/utilisateurs/reset_password.php', {
    method: 'POST',
    body: JSON.stringify({
